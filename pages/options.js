...
Settings.resetSettings = function () {
  if (
    confirm("Reset all configuration and CSS settings to their default values?")
  ) {
    RUNTIME(
      "getDefaults",
      function (defaults) {
  ...
  RUNTIME(
    ...
    function (defaults) {
      ...
      if (res.error !== null) {
        ...
        // TODO:
        Status.setMessage(
          "Error in cVimrc (line " + res.error.lineno + ")",
          2,
          "error"
        );
      } else {
...
Settings.syncGist = function () {
  ...
  if (url.hostname === "gist.github.com") {
    ...
    if (path[2] === "blob") path.splice(2, 1);
...
Settings.init = function () {
  ...
  document
    ...
    .addEventListener("click", this.resetSettings.bind(this), false);
  document
  ...
  document
    .getElementById("gistSync")
    .addEventListener("click", this.syncGist.bind(this));
  this.gistPlaceHolder =
    "https://gist.github.com/1995eaton/9e68803bf1f1e7524340";
