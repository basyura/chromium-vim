...
var Complete = {
  ...
  addEngine: function (name, props) {
    ...
    if (!this.engineEnabled(name)) this.activeEngines.push(name);
  },
  ...
  enableEngine: function (name) {
    if (this.hasEngine(name)) this.activeEngines.push(name);
  },
  ...
  wolframalpha: {
    ...
    queryApi: function (query, callback) {
      httpRequest(
        ...
        function (response) {
          callback(
            response.results.map(function (e) {
              return e.input;
            })
          );
        }
  ...
  webster: {
    ...
    queryApi: function (query, callback) {
      httpRequest(
        ...
        function (response) {
          callback(
            response.suggestions.map(function (e) {
              return e;
            })
          );
        }
  ...
  urbandictionary: {
    ...
    queryApi: function (query, callback) {
      httpRequest(
        ...
        function (response) {
          callback(
            response.slice(1).map(function (e) {
              return e;
            })
          );
        }
